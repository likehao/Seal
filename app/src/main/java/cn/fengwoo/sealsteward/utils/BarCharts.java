...
//        barChart.setDescription("");
        ...
        barChart.setNoDataText("没有数据了");//setNoDataTextDescription("没有数据了");
        ...
        // 字体颜色
        mLegend.setTextColor(R.color.black_3);

        // 获取 左边 Y轴
        YAxis yAxis = barChart.getAxisLeft();
        //不显示左侧Y轴
        yAxis.setDrawAxisLine(false);
        yAxis.setDrawLabels(false); //是否显示Y坐标轴上的刻度，默认是true
        //不显示左侧Y轴，但是图标里的x轴也会没有
...
//        xAxis.setTextColor(0x000000); // 设置轴标签的颜色。
        xAxis.setTextSize(15); // 设置轴标签的文字大小。
        int i = xAxis.getValues().size();  //柱状图个数
